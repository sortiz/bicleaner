...
def parse(args, jobs_queue):
    ...
    def start_element(name, attrs):
        nonlocal langpair, tuid, nline, nblock, current_temp
    ...
    logging.info("Finished parsing of TMX file {}.".format(args.input.name))
    args.input.close()
                    ...
                    if parts[0].startswith("<tu "):
                        ...
                        if pred < args.threshold:
                            ...
                            if args.discarded_tus:
                                args.discarded_tus.write("{}\t{}\t{}\t{}\t{}\n".format(parts[1], parts[3], parts[-3], parts[-2], pred))
